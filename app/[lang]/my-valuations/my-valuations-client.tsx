...
export default function MyValuationsClient({ dictionary }: { dictionary: any }) {
      ...
      <main className="flex min-h-screen flex-col items-center p-4 md:p-8">
        <div className="w-full max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <UserStatus freeValuationsLeft={freeValuationsLeft} tokenBalance={tokenBalance} dictionary={dictionary.userStatus} />
            <ReferralBanner dictionary={dictionary.referral} />
          </div>
          <ValuationsList valuations={mockValuations} dictionary={dictionary} />
        </div>
      </main>
    </ProtectedRoute>
  )
