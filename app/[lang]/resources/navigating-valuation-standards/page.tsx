...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const dictionary = await getArticleDictionary('navigating-valuation-standards', lang)
...
export default async function NavigatingValuationStandardsPage({ params }: Props) {
  const { lang } = await params
  const dictionary = await getArticleDictionary('navigating-valuation-standards', lang)
